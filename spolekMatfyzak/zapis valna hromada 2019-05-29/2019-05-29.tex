...
\newcommand{\LV}{{\it Linzmayer Václav\/}}
...
\paragraph{Přítomní členové:}
  \AS, \AY, \DK, \DN, \DP, \GS, \IK, \KZ, \KS, \LO, \LV, \LC, \MC, \MN, \MM, \MS,
  \NS, \PB, \PH, \VS, \ZT


\vspace{-3mm}
\paragraph{Přítomní hosté:}
\AH
